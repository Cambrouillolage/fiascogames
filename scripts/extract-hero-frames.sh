...
#
# The 169 frames already committed at assets/hero-frames/hero-frame-001.jpg
# ... hero-frame-169.jpg were produced this way. Re-run this only if the
# source video is re-cut/re-rendered; then re-run
...
ffmpeg -y -i "$SRC" \
  -vf "fps=${FPS},scale=1600:900:force_original_aspect_ratio=increase,crop=1600:900" \
  -frame_pts 0 -q:v 2 \
